...
async function fetchEphemerisByDate(displayDate) {
  ...
  url.searchParams.set('select', 'id,display_date,day,month,year,event,historical_day,historical_month,historical_year,bible_reference,verse_text,application,created_at,updated_at')
